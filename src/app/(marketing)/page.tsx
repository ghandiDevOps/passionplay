        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display-md text-xs text-[#FF7A00] tracking-[0.2em]">SPORT · MUSIQUE · CUISINE · DANSE · ART · PETIT GROUPE</span>
            </div>
      ...
      <div className="bg-[#111] border-y border-[#2a2a2a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="grid md:grid-cols-3 gap-0 md:gap-px bg-[#2a2a2a]">
            {[
              { n: "01", title: "TU CHOISIS", desc: "Une passion, une session, un expert. Sport, musique, cuisine, danse… Tu vois les places en temps réel. Tu décides en 20 secondes." },
